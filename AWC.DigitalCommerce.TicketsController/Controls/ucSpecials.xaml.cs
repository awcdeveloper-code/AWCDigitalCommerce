...
namespace AWC.DigitalCommerce.TicketsController.Controls
{
    ...
    /// </summary>
    public partial class ucSpecials : System.Windows.Controls.UserControl
    {
        // MESSAGES
        ...
        public ucSpecials(string _lang)
        {
            lang = _lang;
        ...
        private void btn_AddLunch(object sender, RoutedEventArgs e)
        {
            ...
            if (DB.InsertLunch(lunch))
            {
                if (DB.InsertTicketDetail(itemDetailList, lunch.GUID, Settings.Default.WhoOpen, false))
                {
                    ...
                    wpfMessageBox.Show("Tickets Controller", strLunchAdded, MessageBoxButton.OK, wpfMessageBox.MessageBoxImage.Information, lang);
                }
            }
